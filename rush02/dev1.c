...
/*   Updated: 2024/08/17 19:28:33 by omatyko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_tostr(int input,char **keys,char **values)
{
    char str_key[33];
    //printf("INPUT = %d\n", input);
